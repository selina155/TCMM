...
class TCMMTrainer(RhinoTrainer):  
    def __init__(self,
                 ...
                 causal_decoder,
                 tcsf,
                 use_correct_mixture_index: bool = False,
    ...
    def validation_step(self, batch, batch_idx):
        ...
        unique_graphs = torch.unique(graph_index)
        # for g in unique_graphs:
        #   sample_indices = idx[graph_index == g].cpu().numpy()
        #  print('graph_{g}_sample_indices', str(sample_indices))
