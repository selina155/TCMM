...
def train(cfg):
    ...
    training_needed = cfg.model in ['rhino', 'mcd','gnn']
    ...
    if dataset in ['ecoli1','ecoli2','yeast1','yeast2','yeast3','dream3_combined']:#ignore self-connections in dream3 dataset
